...
public class PrototypePatternDemo {
    ...
    public static void main(String[] args) {
        ...
        Shape circle = ShapeCache.getShape(ShapeCache.CIRCLE);
        System.out.println("Shape: " + circle.getType());

        Shape square = ShapeCache.getShape(ShapeCache.SQUARE);
        System.out.println("Shape: " + square.getType());

        Shape rectangle = ShapeCache.getShape(ShapeCache.RECTANGLE);
